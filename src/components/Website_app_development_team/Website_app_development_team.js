        ...
        <div className="d-flex justify-content-center align-items-center">
          <div className={styles.container + ` container`}>
            <div className={styles["h2-container"]+` mb-3`}>
              <h2 className={styles["h2-title"]} id="project">What is a project</h2>
            </div>
              <p>
              ...
              <div className={styles["h2-container"]+` mb-3`}>
              <h2 className={styles["h2-title"]} id="managementtools">Project Management Tools for Teams</h2>
            </div>
            <p>
