        ...
        <div className="d-flex justify-content-center align-items-center">
          <div className={styles.container + ` container`}>
            <div className={styles["h2-container"]+` mb-3`}>
              <h2 className={styles["h2-title"]} id="website">Websites and webpages</h2>
            </div>
            <p>
              ...
              <h3 className={styles["h2-title"]} id="howtowebsite">How to make a website</h3>
              <p>
              ...
              <h3 className={styles["h2-title"]} id="websitebuildersites">Web builder sites</h3>
              <p>
              ...
              <div className={styles["h2-container"]+` mb-3`}>
              <h2 className={styles["h2-title"]} id="makeyourwebsite">Make your own website</h2>
            </div>
            <p>
